...
static void sort_menu(void) {
    ...
    int m = read_int("");
    SortMethod method = (m == 1) ? BUBBLE : (m == 2) ? INSERTION : MERGE;
    printf("Sort by:\n1. ID\n2. Average\nChoose: ");
    int k = read_int("");
...
void run_menu(void) {
    ...
    while (1) {
        ...
        int choice = (int)v;
        switch (choice) {
            case 1: add_student_menu(); break;
            case 2: add_grade_menu(); break;
            case 3: display_all_students(); break;
            case 4: display_grade_matrix(); break;
            case 5: sort_menu(); break;
            case 6: search_menu(); break;
            case 7: stats_menu(); break;
            case 8: delete_menu(); break;
            case 9: update_menu(); break;
            case 0:
                save_students_to_file();
                free_students();
                puts("Goodbye.");
